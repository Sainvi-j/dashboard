    ...
    <div className="main">
      ...
      <div className="box-container">
        <div className="box box1">
          <div className="text">
            ...
            <h2 className="topic">product Views</h2>
          </div>
          <img
      ...
      <div className="report-container">
        <div className="report-header">
          <h1 className="recent-products">Recent products</h1>
        ...
        <div className="report-body">
          ...
          <div className="items">
            <div className="item1">
              <h3 className="t-op-nextlvl">product 73</h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">product 72</h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">product 71</h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">product 70</h3>
